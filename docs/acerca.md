...
Acutalmente estoy desarrollando una **agencia de autamtización impulsada con Inteligencia Artificial**, llamada [AtomLabs.AI](https://atomlabs-ia.vercel.app/). Me apasion el riesgo del mundo emprendedor y poder combinarlo con lo aprendido en la carrera es lo que más impulsa el crecimineto de **AtomLabs**.

## Habilidades
- Nivel **Profesional** de Inglés (C2)
- Competencias Avanzadas de Python para **Machine Learning**
- Conocimiento **Profundo** en Análisis de Datos, Visualización de Datos y Manejo de datos
